  ...
  <div class="accident-wrapper">
    ...
    <a-button shape="circle" style="margin-left: 15px" @click="getItemList">
      <template v-slot:icon>
        <ehf-icon icon="refresh-line"></ehf-icon>
      </template>
    </a-button>
      ...
      >
        ...
        <a-table-column key="action" title="操作" width="200px">
          <template v-slot="{ record }">
            <a-button type="primary" @click="editAccident(record)" size="small">
              编辑
            </a-button>
            <a-popconfirm
              title="确定要删除这条不良事故吗?"
            ...
            >
              <a-button type="danger" size="small" :loading="record.loading">
                删除
              </a-button>
            </a-popconfirm>
          </template>
